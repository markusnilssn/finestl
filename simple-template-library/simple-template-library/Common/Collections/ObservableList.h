...
namespace stl
{
	...
	public:
		...
		void Reserve(const std::size_t aCapacity);
	...
	template<typename T>
	inline void ObservableList<T>::Reserve(const std::size_t aCapacity)
	{
		m_List.Reserve(aCapacity);
	}
